...
- The catalog's first content is the 32-entry role-play batch recorded in [Roleplay preset catalog and its content boundary](2026-09-10-roleplay-preset-catalog.md); `presets/catalog.json` in dsh-presets remains the publishing source, with the content requirements stated in `presets/README.md`. Review quality of a composition remains a human process; the confirmation gate and provenance reduce accidental risk, not hostile intent.
