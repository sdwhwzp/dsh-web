...
- Pulling the lever down composes LiangShen mode for the current session; pushing it up restores the preset the user was on before, falling back to the deployment default when the page has not seen a prior pick.
