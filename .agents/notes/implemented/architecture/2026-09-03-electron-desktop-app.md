...
Superseded (2026-09-24, see [remove the repository's Electron desktop app](../simplification/2026-09-24-remove-electron-desktop-app.md)): the app and its packaging workflow were deleted; the desktop surface is the official DeepSeek Harness desktop client.
