...
The 0.4 family mounts pet, skin center and the community index as external packages. Production uses the exact accepted artifacts in `manifest.json`; the aggregate's public dependency ranges are build inputs and do not authorize replacing these production pins.
