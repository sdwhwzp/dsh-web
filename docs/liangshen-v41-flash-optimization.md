...
| **工具结果修剪** | 8192 字符宽松截断 | 4096 字符激进修剪 (head: 1500, tail: 500) | 避免工具日志污染两级稀疏索引器 |
