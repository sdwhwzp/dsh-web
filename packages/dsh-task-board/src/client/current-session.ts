// Generated by scripts/sync-shared.mjs from shared/client/current-session.ts. Do not edit this copy; edit the shared source and run "node scripts/sync-shared.mjs".
/**
