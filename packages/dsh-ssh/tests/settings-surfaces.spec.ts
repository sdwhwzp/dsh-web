...
describe('dsh-ssh host surfaces follow the plugin config', () => {
  it('operator edits display settings live while account isolation requires remounting', () => {
    ...
    // Then display fields are editable live, while account isolation stays in the profile
