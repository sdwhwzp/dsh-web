...
export const zh = {
  ...
  'form.accountProxyJumpHint': '仅限当前账号已配置的跳板机别名，逗号分隔，按顺序连接',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'form.accountProxyJumpHint': 'Only jump host aliases configured in this account; separate with commas to connect in order',
  'form.proxyCommand': 'ProxyCommand',
