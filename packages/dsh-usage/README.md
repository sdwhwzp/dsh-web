...
Requires DSH 0.1.7-rc.1 or later: the plugin is developed against the 0.1.7-rc.1 DSH cohort (its settings page is the Host-generated page of the plugin's own Config schema) and its `@deepseek-ai/*` runtime imports are provided by the host itself.
