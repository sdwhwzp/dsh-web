...
- **Session archive**: archive and restore remain owned by the Harness native session UI. The aggregate does not install an external manager that reads or deletes persistence files directly.
