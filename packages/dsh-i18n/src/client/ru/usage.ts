...
export const ru: Record<string, string> = {
  ...
  'usage.sidebar.balanceLeft': 'Осталось {balance}',
  'usage.sidebar.empty': 'Нет настроенных тарифов или балансов.',
  'usage.sidebar.entry.label': 'Использование',
  'usage.sidebar.entry.tooltip': 'Панель использования: квоты тарифов и балансы',
  'usage.sidebar.error': 'Ошибка загрузки: {error}',
  'usage.sidebar.loading': 'Загрузка данных об использовании…',
  'usage.sidebar.toggle.collapse': 'Свернуть',
  'usage.sidebar.toggle.expand': 'Развернуть',
  'usage.sidebar.todayUsage': 'Сегодня {tokens} токенов',
